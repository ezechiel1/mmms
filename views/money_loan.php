...
<?php endforeach; endif; ?>
                        ...
                        <div class="row form-group">
                            <div class="col col-md-2"><label for="hf-email" class=" form-control-label">Date Loan </label></div>
                            <div class="col-12 col-md-10"><input type="date" id="hf-email" name="date_loan" value="<?= $db->showDate('date') ?>"  class="form-control"></div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-2"><label for="hf-email" class=" form-control-label">Date Echeance </label></div>
                            <div class="col-12 col-md-10"><input type="date" id="hf-email" name="date_echeance"  class="form-control"></div>
                        </div>
